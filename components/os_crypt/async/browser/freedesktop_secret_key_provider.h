...
#else
  static constexpr char kKWalletFolder[] = "Ark Browser Keys";
  static constexpr char kKeyName[] = "Ark Browser Safe Storage";
  static constexpr char kAppName[] = "ark-browser";
#endif
